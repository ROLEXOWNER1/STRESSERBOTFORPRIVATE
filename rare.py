...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '8001042691:AAHKyGO2MwjXtkHC8jz73PsM_inTW7EL56I'
ADMIN_USER_ID = 7339144301 
ADMIN_USER_ID = 6906270448 
...
async def attack(update: Update, context: CallbackContext):
    ...
    if argument_type == 3:
        ...
        attack_command = f"./rare {ip} {port} {duration} {byte_size} {threads}"
